<h1>Extract Social Media Data from Twitter and Facebook</h1>  [![Build Status](https://travis-ci.org/xbwei/Data-Mining-on-Social-Media.svg?branch=master)](https://travis-ci.org/xbwei/Data-Mining-on-Social-Media)
