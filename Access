...
db_file = 'C:\\Project\\JMU\\2016 Fall\\IA 340\\programming\\test.mdb' #define the location of your Access file
...
sql_insert_statement = "delete from teacher where id = 20" # edit the SQL statement that want to execute
